...
* Menuliskan hasil analisis *path model* dalam laporan penelitian
...
* Pengantar SEM: model struktural vs model pengukuran (LVM)
* Tahapan *modeling* dengan menggunakan SEM
  ...
  * Menguji model
  * Memodifikasi model
* Jenis-jenis kriteria *model fit*
  * *Model fit*
  * *Model comparison*
  * *Model parsimony*
  * *Parameter fit*
...
<center><img src="docs/poster.jpg" style="width:70%;" class="fancyimage"/></center><br>
