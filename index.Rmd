...
* Koefisien jalur (*path coefficients*)
  * *X*, δ (delta), *Y*, ε (epsilon), ξ (ksi), η (eta), λ (lambda), γ (gamma), β (beta), φ (phi), ζ (zeta)
...
* Pengantar SEM: model struktural vs model pengukuran
* Tahapan *modeling* dengan menggunakan SEM
  ...
  * Menguji model
  * Memodifikasi model
* Jenis-jenis kriteria kecocokan model (*model fit*)
