...
* Variabel Eksogen dan Endogen
  - Variabel eksogen `r fa("arrow-circle-right")` variabel yang memberikan *direct effect* saja
  - Variabel endogen `r fa("arrow-circle-right")` variabel yang menerima *direct effect* saja
