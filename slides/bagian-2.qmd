...
* **Adanya data *outlier*** <i class="fa-solid fa-circle-arrow-right"></i> adanya data yang *outlier* membuat estimasi korelasi menjadi *inflated*.
* **Koreksi atenuasi** <i class="fa-solid fa-circle-arrow-right"></i> akan dibahas di bagian selanjutnya.
...
* ***Missing data***
  ...
  - Ada beberapa pilihan: <i class="fa-solid fa-circle-arrow-right"></i> *listwise deletion*, *pairwise deletion*, dan *data imputation*.
  - *Listwise deletion* tidak disarankan karena membuat jumlah sampel turun drastis <i class="fa-solid fa-circle-arrow-right"></i> mengurangi *statistical power*.

# Unduh dataset contoh {background-color="#14497F"}

Silahkan unduh dan buka [**Dataset Korelasi**](https://rameliaz.github.io/mg-sem-workshop/materials/corr.jasp), untuk melihat contoh.
...
* Mengapa terjadi?
  ...
  - Sepasang variabel berbagi **varians negatif** atau **tidak sama sekali** (0) <i class="fa-solid fa-circle-arrow-right"></i> *Heywood case*
...
Menggunakan [Dataset Contoh Korelasi](https://rameliaz.github.io/mg-sem-workshop/materials/corr.csv)

[[Dataset]](https://rameliaz.github.io/mg-sem-workshop/materials/corr.omv)
[[Matriks di Excel]](https://rameliaz.github.io/mg-sem-workshop/materials/contoh-atenuasi.xlsx)
...
[[Unduh Dataset]](https://rameliaz.github.io/mg-sem-workshop/materials/latihancorr.csv)
