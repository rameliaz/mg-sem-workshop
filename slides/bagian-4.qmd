...
* Reflektif
  ...
  - Biasanya mengasumsikan bahwa **korelasi antar-variabel indikator = 0** {{< fa circle-arrow-right >}} artinya, tiap indikator mengukur aspek yang unik dari variabel laten, tidak tumpang tindih
...
## Contoh *syntax* `semTools`{{< fa brands r-project >}}: Menghitung AVE
...
Output yang dihasilkan mencakup baris-baris berikut:
