...
* Perangkat lunak SEM sudah cukup *user-friendly*
  ...
  - Selain itu, peneliti dapat menggunakan [`Ωnyx`](https://onyx-sem.com/), `LISREL`, [`SPSS AMOS`](https://www.ibm.com/products/structural-equation-modeling-sem), `EQX`, [`Mplus`](https://www.statmodel.com/), [`STATA`](https://www.stata.com/features/structural-equation-modeling/), [`lavaan`](http://lavaan.ugent.be/tutorial/index.html) (+ [`semTools`](https://cran.r-project.org/web/packages/semTools/index.html)) di {{< fa brands r-project >}} atau [`semopy`](https://semopy.com) di {{< fa brands python >}} dsb.
::: 
...
* [_Mixture model_](https://daob.nl/wp-content/uploads/2015/06/oberski-LCA.pdf) {{< fa circle-arrow-right >}} untuk mengungkap subpopulasi berdasarkan distribusi variabel laten (*person-centered methods*, e.g., [*latent categorical analysis* (LCA) dan *latent profile analysis* (LPA)](https://osf.io/preprints/psyarxiv/97uab_v1))
