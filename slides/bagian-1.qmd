...
* Perangkat lunak SEM sudah cukup *user-friendly*
  ...
  - Selain itu, peneliti dapat menggunakan `Onyx`, `LISREL`, `SPSS AMOS`, `EQX`, `Mplus`, `STATA`, [`lavaan`](http://lavaan.ugent.be/tutorial/index.html) (+ [`semTools`](https://cran.r-project.org/web/packages/semTools/index.html)) di {{< fa brands r-project >}} atau `semopy` di {{< fa brands python >}} dsb.
::: 
