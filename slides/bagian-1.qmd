...
::: {.incremental}
* **Variabel eksogen**
  - Variabel yang **tidak menerima** _direct effect_ dari variabel lain di dalam model — hanya memberi efek pada variabel lain

* **Variabel endogen**
  - Variabel yang **menerima** _direct effect_ dari variabel lain di dalam model — bisa sekaligus memberi efek pada variabel endogen lainnya (misalnya variabel mediator)
:::
:::
...
* Model pengukuran (*measurement model*/*confirmatory factor analysis*)
  - Menguji apakah item-item dari skala Psikologi (biasanya variabel *observed*) memang mengukur konstruk yang dihipotesiskan (biasanya variabel *latent*) <i class="fa-solid fa-circle-arrow-right"></i> validitas konstruk.
...
* Perangkat lunak SEM sudah cukup *user-friendly*
  - `jamovi` dan [`JASP`](https://jasp-stats.org/) adalah perangkat lunak SEM yang hanya memerlukan *coding* yang sangat minimal.
  - Namun `jamovi` dan `JASP` fungsinya terbatas, terutama ketika peneliti menguji model yang sangat kompleks.
  - Selain itu, peneliti dapat menggunakan [`Ωnyx`](https://onyx-sem.com/), `LISREL`, [`SPSS AMOS`](https://www.ibm.com/products/structural-equation-modeling-sem), `EQX`, [`Mplus`](https://www.statmodel.com/), [`STATA`](https://www.stata.com/features/structural-equation-modeling/), [`lavaan`](http://lavaan.ugent.be/tutorial/index.html), atau [`sem`](https://cran.r-project.org/web/packages/sem/index.html) (+ [`semTools`](https://cran.r-project.org/web/packages/semTools/index.html) dan [`semPower`](https://moshagen.github.io/semPower/)) di <i class="fa-brands fa-r-project"></i> atau [`semopy`](https://semopy.com) di <i class="fa-brands fa-python"></i> dsb.
::: 
...
* PLS juga bisa digunakan untuk menguji model reflektif, **TETAPI** PLS mengestimasi variabel laten sebagai ***weighted composite*** (bukan *common factor*), sehingga berbeda secara fundamental dari CB-SEM.
...
* [_Mixture model_](https://daob.nl/wp-content/uploads/2015/06/oberski-LCA.pdf) <i class="fa-solid fa-circle-arrow-right"></i> untuk mengungkap subpopulasi berdasarkan distribusi variabel laten (*person-centered methods*, e.g., [*latent categorical analysis* (LCA) dan *latent profile analysis* (LPA)](https://osf.io/preprints/psyarxiv/97uab_v1))
* [_Latent growth curve_](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2888524/)
