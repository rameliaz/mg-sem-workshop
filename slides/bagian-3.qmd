...
Yang harus dipenuhi sebagai bukti kausalitas (X {{< fa circle-arrow-right >}} Y):

* Ada **urut-urutan waktu kejadian** (*temporal order*) {{< fa circle-arrow-right >}} desain penelitian *panel*/*longitudinal*/*time series*
...
* [`SEMLj`](https://semlj.github.io/) menyediakan dua opsi: fitur _syntax_ atau _interactive_
...
* `jamovi` dan `JASP` mengadopsi *syntax* dari {{< fa brands r-project >}} *package* [`lavaan`](http://lavaan.ugent.be/tutorial/index.html), sehingga untuk menspesifikasi model, kita harus memasukkan **serangkaian perintah**.
