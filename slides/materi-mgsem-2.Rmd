...
* Jumlah *variance-covariance* yang diestimasi adalah ***p*(*p*+1)/2**
  - Sehingga dengan contoh di atas maka jumlah *variance-covariance* yang diestimasi adalah 3(3+1)/2=6, yaitu **3 varians (diagonal)** dan **3 *covariance* (sisanya)**.
...
* *Standarised solution/estimates*
  ...
  - Berguna untuk membandingkan *loading factor* antar-variabel di dalam model - peneliti dapat mengidentifikasi, variabel mana yang paling berkontribusi menjelaskan *dependent variable*.
...
* Ada banyak perbedaan pendapat mengenai metrik mana yang harus dilaporkan, tetapi
  - Selalu laporkan *unstandarised solution/estimates* `r fa("arrow-circle-right")`

---

## TUGAS: Membuat *correlation matrix* dan melakukan *koreksi atenuasi*
...
[[Unduh Dataset]](https://rameliaz.github.io/mg-sem-workshop/latihancorr.xlsx) [[Kumpulkan Tugasnya Disini]](https://forms.gle/rS5HjhTAFBJnRYRA6)
