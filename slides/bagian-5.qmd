...
* Dihitung dengan cara membandingkan **model yang dihipotesiskan (*implied model*)** dengan ***saturated model*** (model dengan *fit* sempurna — semua parameter dibebaskan)
...
* Meliputi
  ...
  - ***Standardized Root Mean Square Residual*** (SRMR/RMR) {{< fa circle-arrow-right >}} nilai **< 0.08** menunjukkan *acceptable fit* (konsisten dengan kriteria pada *parsimony index* di atas)
...
* Bagaimana kalau *global fit* ditolak (e.g., uji χ² dengan *p* < 0.05)
  ...
  - `jamovi` bisa menyimpan *residual correlation* sebagai *output* yang bisa disimpan - klik ***Output options*** {{< fa circle-arrow-right >}} ***covariances and correlations*** {{< fa circle-arrow-right >}} centang ***Residual***
