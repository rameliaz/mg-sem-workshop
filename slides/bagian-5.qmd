...
* Selain χ², kita bisa menggunakan *alternative fit indices* yang terdiri atas: *Incremental index*, *Parsimony index*, dan *Absolute (standalone) index*.
...
* Bagaimana kalau *global fit* ditolak (e.g., uji χ² dengan *p* < 0.05)
  ...
  - *Reviewer* yang familiar dengan SEM akan selalu menanyakan justifikasi keputusan peneliti untuk mempertahakan model ketika uji χ² nonsignifikan
